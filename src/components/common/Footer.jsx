        ...
        <div className="w-[95%] max-w-custom mx-auto flex flex-col items-center gap-16">
          ...
          <div className="flex flex-col gap-12 w-full">
            ...
            >
              <span className="text-base md:text-lg text-white uppercase">
                <AnimateTextWord>
                  Aaquib | NOUN | a person who defeats an enemy or opponent in a
          ...
          <div className="w-full overflow-hidden flex items-center justify-center">
            <Link
              ...
              href={
                "mailto:aaquibm502@gmail.com?subject=Hey! lets work! Love your works!"
              }
            ...
            >
              <Magnetic bgColor={"#fff"}>aaquibm502@gmail.com</Magnetic>
            </Link>
          </div>
